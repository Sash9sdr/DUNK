    ...
    <div className="min-h-screen relative flex flex-col bg-[#050505] overflow-x-hidden selection:bg-menu-highlight selection:text-white">
      ...
      <div className="fixed inset-0 z-0 pointer-events-none overflow-hidden">
         ...
         <motion.div 
            ...
            className="absolute -top-[10%] left-1/2 -translate-x-1/2 w-[100vw] h-[800px] blur-[120px]" 
         />
         ...
         <motion.div
            ...
            className="absolute top-[10%] -left-[10%] w-[800px] h-[800px] rounded-full blur-[100px]"
         />
         ...
         <motion.div
            ...
            className="absolute bottom-[20%] -right-[10%] w-[600px] h-[600px] bg-menu-highlight/30 rounded-full blur-[120px]"
         />

         {/* Floating Orb (Interesting Element) */}
         <motion.div
            initial={false}
            animate={{
              x: ['-50%', '50%', '-50%'],
            ...
            className="absolute top-1/2 left-1/2 w-[400px] h-[400px] opacity-20"
         >
             <div className="w-full h-full bg-menu-highlight blur-[150px] rounded-full mix-blend-screen"></div>
         </motion.div>
      </div>
      ...
      <header className="fixed top-0 left-0 right-0 z-50 transition-all duration-300">
        {/* Glass Container */}
        <div className="absolute inset-0 bg-[#0a0a0a]/85 backdrop-blur-xl border-b border-white/5 shadow-[0_4px_30px_rgba(0,0,0,0.5)] supports-[backdrop-filter]:bg-black/40"></div>
